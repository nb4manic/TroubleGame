...
# red win_state
red_pivot = my_board[1][0]
red_win_coordinates = [my_board[1][1], my_board[1][2], my_board[1][3], my_board[1][4]]

# blue win_state
blue_pivot = my_board[0][5]
blue_win_coordinates = [my_board[1][5], my_board[2][5], my_board[3][5], my_board[4][5]]

# green win_state
green_pivot = my_board[5][6]
green_win_coordinates = [my_board[5][5], my_board[5][4], my_board[5][3], my_board[5][2]]

# yellow win_state
yellow_pivot = my_board[6][1]
yellow_win_coordinates = [my_board[5][1], my_board[4][1], my_board[3][1], my_board[2][1]]
